-- 001_initial_schema.sql (Postgres)
-- Converted from src/lib/db/migrations/001_initial_schema.sql (SQLite).
-- Dialect changes: INTEGER PRIMARY KEY AUTOINCREMENT -> GENERATED ALWAYS AS IDENTITY.
